...
To start a game, download NAS_exec and open snake.jar (you should have JVM installed)
...
If you want to compile it, don't forget to add jars which are located in natives/jars
